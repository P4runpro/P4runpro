...
control IngressRPB1(
        ...
        action report() {
            //eval
            hdr.ethernet.ether_type = 0x6666;
            hdr.meta.rec.egress_port = 168;
        ...
        action extract_hdrl5op_har() {
            hdr.meta.reg.har = (bit<32>)hdr.l5.op;
        }
        ...
        action modify_hdrl5key2_sar() {
            hdr.l5.key2 = hdr.meta.reg.sar;
        }
